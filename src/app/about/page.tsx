...
const ListSection: React.FC<{
  ...
  <section className={`mt-10 py-4 ${className}`}>
    ...
    <h2 className="text-4xl font-extrabold text-high-contrast-text mb-6 border-b border-primary-dark pb-2">
      {title}
    </h2>
    ...
    <div className="bg-app-background min-h-screen text-app-text pt-16 pb-24">
      <main className="container mx-auto max-w-5xl px-4">
        ...
        <header className="text-center mb-12 pb-8 border-b border-border-secondary">
          ...
          <p className="text-secondary-text text-lg">{header.subtitle}</p>
        </header>

        {/* Intro */}
        <section className="">
          {/* Quote (will now use the readable font) */}
          <p className="text-xl italic text-text-base mb-6 border-l-4 border-secondary pl-4">
            {renderHtml(intro.quote)}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6">
            <div>
              {/* Primary Accent Text */}
              <span className="text-xl font-bold text-primary mb-2 uppercase tracking-wide">
                Mission
              </span>
        ...
        {/* Story */}
        <ListSection title="The Evidence">
        ...
        <ListSection title="AI Integration Philosophy">
          <div className="space-y-4">
        ...
        <ListSection title="Technical Skills & Competencies">
          <div className="space-y-8 text-lg">
            <div>
              <h4 className="text-xl font-semibold text-high-contrast-text mb-3">
                TECHNICAL SKILLS
              </h4>
            ...
            <div>
              ...
              <div className="space-y-4 text-secondary-text">
                {evidence.technicalSkills.explorationAreas.map(
                  (area, index) => (
                    <div key={index}>
